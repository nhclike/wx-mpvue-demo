...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_YearProgress__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_wafer2_client_sdk__ = __webpack_require__(124);
    ...
    addBook: function addBook() {
      wx.request({
        ...
        success: function success(res) {
          ...
          Object(__WEBPACK_IMPORTED_MODULE_0__util__["a" /* showModal */])("添加图书", data.title + "添加成功");
        }
      });
    },
        ...
        __WEBPACK_IMPORTED_MODULE_2_wafer2_client_sdk___default.a.login({
          success: function success(userInfo) {
            __WEBPACK_IMPORTED_MODULE_2_wafer2_client_sdk___default.a.request({
              url: __WEBPACK_IMPORTED_MODULE_3__config__["a" /* default */].userUrl,
              login: true,
              success: function success(userRes) {
                Object(__WEBPACK_IMPORTED_MODULE_0__util__["b" /* showSuccess */])('获取用户信息成功');
                // 用户信息存储
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_YearProgress_vue__ = __webpack_require__(122);
